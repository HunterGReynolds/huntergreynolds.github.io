...
#+begin_quote
This post is a continuation of [[../gb-hello/][this previous post]].
...
[[https://github.com/HunterGReynolds/gameboy_drawing_a_sprite][this GitHub repo]].
...
You can find a more detailed explanation of this information [[https://gbdev.io/pandocs/Graphics.html][over at the PanDocs]].
...
[[https://rgbds.gbdev.io/docs/v0.9.1/rgbasm.5#Offset_constants][this link]] to see documentation for the RS commands, but
...
explanation. You may want to refernce [[https://rgbds.gbdev.io/docs/v0.9.1/rgbasm.5#RAM_code][this PanDoc page]] for the
details about =LOAD= blocks. But the idea is that we need to get the =dma_init= code loaded into HRAM so we can call it
later.

**** OAM DMA Copy

I highly recommend reading [[https://gbdev.io/pandocs/OAM_DMA_Transfer.html][the PanDocs]] page about OAM DMA transfer, as
